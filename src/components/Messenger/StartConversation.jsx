...
export default function StartConversation({ recipientId: propRecipientId, recipientName: propRecipientName, isOpen, onClose, onConversationCreated }) {
  ...
  const finalRecipientName = propRecipientName || selectedRecipient?.name || selectedRecipient?.email;
  ...
  return (
    <div className="start-conv-overlay" onClick={onClose}>
      <div className="start-conv-container" onClick={(e) => e.stopPropagation()}>
        <div className="start-conv-header">
          <h3>{finalRecipientId ? `Message ${finalRecipientName}` : "New Conversation"}</h3>
          ...
          {!propRecipientId && selectedRecipient && (
            <div className="selected-recipient">
              ...
              <span className="recipient-chip">
                ...
                <button onClick={() => setSelectedRecipient(null)}><IoClose size={14}/></button>
              </span>
            </div>
          )}

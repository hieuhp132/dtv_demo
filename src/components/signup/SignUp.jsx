    ...
    try {
      const res = await fetch(`${API_BASE}/db/users/signup`, {
        ...
        body: JSON.stringify({
          ...
          email,
          password,
          promodeCode: promodeCode || null // bạn có thể gửi mã nếu cần
        })
      });
      ...
      setServerMessage("Lỗi kết nối đến server");
    }
  ...
  return (
    <div className="container">
      <form className={`form ${isShaking ? "shake" : ""}`} onSubmit={handleSubmit}>
        <p className="title"><strong>Create new account</strong></p>
        ...
        <div className="form-options">
          <div className="remember-me">
            <input
              ...
              style={{borderRadius: 4, border:"2px solid rgba(255, 165, 0, 0.6)", width: "30%"}}
            />
            <label htmlFor="promodeCode">Promodecode (Optional)</label>
          </div>

          <button type="submit" disabled={isSubmitting} style={{width: "50%"}}>
